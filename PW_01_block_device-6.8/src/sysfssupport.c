...
static ssize_t PwbdpClassAttributeAddShow(const struct class *Class,
                                          const struct class_attribute *Attribute, char *Buffer);

static ssize_t PwbdpClassAttributeAddStore(const struct class *Class,
                                           const struct class_attribute *Attribute,
